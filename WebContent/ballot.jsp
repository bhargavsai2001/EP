...
stipulated therein.My vote is for Mr./Mrs. <span>
	...
	<div class="votebox us" id="procedure">
		...
		<ol>
			...
			<li>Nominees may spend no more than â‚¹20,000 in direct campaign expenses. Candidates will be required to provide a written report of campaign expenses with attached receipts.</li>
